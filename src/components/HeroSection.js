      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-5 justify-center lg:justify-start">
            <button className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-red-600 text-white font-bold rounded-sm transition-colors hover:bg-red-700 flex items-center justify-center gap-3 shadow-lg shadow-red-600/20">
              GET A FREE PROPOSAL <ChevronRight size={20} />
            </button>
            
            <button className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-white/5 text-white font-bold border border-white/10 rounded-sm hover:bg-white/10 transition-colors flex items-center justify-center gap-3"> 
        ...
        <div className="relative hidden lg:block">
          <div className="relative bg-[#111114] border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="bg-white/5 p-5 rounded-xl border border-white/10 flex items-center gap-5 transition-colors hover:bg-white/[0.08]">
